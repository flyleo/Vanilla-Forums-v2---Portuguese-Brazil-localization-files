...
$Definition['ValidateTimestamp'] = '%s não é um formato de data válido.';
...
$Definition['ErrorPermission'] = 'Desculpe, acesso proibido.';
$Definition['ErrorCredentials'] = 'Por favor, verifique o endereço de e-mail ou senha ou registre-se!';
$Definition['ErrorPluginVersionMatch'] = 'O plugin {0} (versão {1}) não suporta os seguintes versões: ({2}).';
$Definition['ErrorPluginDisableRequired'] = 'Para ativar o plugin {0}, é necessário que o plugin {1} esteja desabilitado.';
