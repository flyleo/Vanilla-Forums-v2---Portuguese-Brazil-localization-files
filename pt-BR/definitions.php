...
$LocaleInfo['pt-BR'] = array( // make sure the key of this array is the same as its folder name.
   'Locale'       => 'pt-BR',
   'Name'         => 'Portuguese Brasil Locale',
   'Description'  => 'This is a pt-Br locale.',
   'Version'      => '2.0.1',
   'Author'       => "marciogm",
   'AuthorEmail'  => '@marciogm',
   'AuthorUrl'    => 'http://www.marciogm.com.br',
   'License'      => 'MIT'
);

// Homepage
$Definition['Sign In'] = 'Fazer Login';
$Definition['Apply for Membership'] = 'Registrar-se';
$Definition['Enter your Email address'] = 'Insira seu Email';
$Definition['Request a new password →'] = 'Solicitar uma nova senha →';
$Definition['Sign In →'] = 'Fazer Login →';
$Definition['Forgot your password?'] = 'Esqueceu a sua senha?';
$Definition['Apply for membership'] = 'Registrar-se';
$Definition['Register for Membership'] = 'Registrar-se';
$Definition['Registration is currently closed.'] = 'Atualmente novos registros estão fechados.';
$Definition['It looks like you\'re new here. If you want to take part in the discussions, click one of these buttons!'] = 'Parece que você é novo por aqui. Se quiser participar das discussões, clique em um desses botões!';
...
$Definition['No results for \'%s\''] = 'Nenhum resultado para \'%s\'';
$Definition['Search results for \'%s\''] = 'Resultados de busca para \'%s\'';
...
$Definition['%1$s joined.'] = '%1$s se inscreveu.';
$Definition['%1$s accepted %4$s invitation for membership.'] = '%1$s aceitou o convite de %4$s para parcipar como membro.';
$Definition['%3$s approved %2$s membership application.'] = '%3$s aprovou %2$s como membro.';
$Definition['%3$s created an account for %1$s.'] = '%3$s criou uma conta para %1$s.';
$Definition['%1$s updated %6$s profile.'] = '%1$s atualizou perfil de %6$s.';
$Definition['%1$s wrote on %4$s %5$s.'] = '%1$s escreveu no %5$s de %4$s.';
$Definition['%1$s changed %6$s profile picture.'] = '%1$s alterou a imagem de perfil de %6$s.';
$Definition['%1$s changed %4$s permissions.'] = '%1$s alterou as permissões de %4$s.';
$Definition['%1$s commented on %4$s %8$s.'] = '%1$s comentou em %8$s de %4$s.';
$Definition['%1$s was added to the %2$s %3$s.'] = '%1$s foi adicionado ao %3$s de %2$s.';
$Definition['%1$s was removed from the %2$s %3$s.'] = '%1$s foi removido de %3$s de %2$s.';
$Definition['%1$s was removed from the %2$s %3$s and added to the %4$s %5$s.'] = '%1$s foi removido de %2$s %3$s e adicionado ao %4$s %5$s.';
$Definition['You'] = 'Você';
$Definition['you'] = 'você';
$Definition['your'] = 'seu';
$Definition['he'] = 'ele';
...
$Definition['Clear Conversation History'] = 'Apagar histórico da conversa';
$Definition['In this Conversation'] = 'Nessa conversa';
$Definition['%s and you'] = '%s e você';
$Definition['Add People to this Conversation'] = 'Adicionar pessoas nessa conversa';
$Definition['Add'] = 'Adicionar';
$Definition['You do not have any conversations.'] = 'Você não está em nenhuma conversa.';
...
$Definition['You have not started any discussions.'] = 'Você não inicou nenhuma discussão.';
...
$Definition['Reopen'] = 'Re-abrir';
$Definition['Delete'] = 'Apagar';
$Definition['Delete Discussion'] = 'Apagar discussão';
...
$Definition['Save'] = 'Gravar';
$Definition['Remove My Picture'] = 'Remover minha imagem';
$Definition['Remove Picture'] = 'Remover imagem';
$Definition['Your picture has been removed.'] = 'Sua imagem foi removida.';

$Definition['Edit My Account'] = 'Editar minha conta';
$Definition['Edit Account'] = 'Editar conta';
$Definition['Edit User'] = 'Editar usuário';
...
$Definition['You have %s invitations left for this month.'] = 'Você tem %s convites restantes para esse mês.';
$Definition['Enter the email address of the person you would like to invite:'] = 'Insira o endereço de email da pessoa que você quer convidar:';
...
$Definition['Send %s a Message'] = 'Enviar uma mensagem para %s';

$Definition['About'] = 'Sobre';
$Definition['Name'] = 'Nome';
$Definition['Joined'] = 'Desde';
$Definition['Visits'] = 'Visitas';
$Definition['Last Active'] = 'Última vez';
$Definition['Roles'] = 'Permissões';
$Definition['Write something about yourself...'] = 'Escreva algo sobre você...';

$Definition['Password'] = 'Senha';
$Definition['Remember me on this computer'] = 'Lembrar-me nesse computador';
$Definition['or'] = 'ou';
$Definition['Clear'] = 'Apagar';
...
$Definition[''] = '';
$Definition[''] = '';
// $Definition['Ex-members who do not have permission to sign in.'] = 'Ex-Mitglieder, die sich nicht mehr einloggen dürfen'; // geht nicht
$Definition[''] = '';
$Definition[''] = '';
$Definition[''] = '';
$Definition[''] = '';
